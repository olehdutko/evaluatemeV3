...
import { ResultDetail } from '../../../../../components/campaigns/ResultDetail';
    ...
    <div className="container mx-auto px-4 py-8">
      <Breadcrumbs
        items={[
          ...
          { label: 'Results', href: `/campaigns/${id}/results?companyId=${encodeURIComponent(companyId)}` },
          { label: 'Result detail' },
        ]}
      />
      <ResultDetail campaignId={id} resultId={resultId} companyId={companyId} />
    </div>
  );
}
